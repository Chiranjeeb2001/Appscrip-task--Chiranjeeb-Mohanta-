...
export default function WebPLPWithFilterPage() {
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined') {
      ...
      const targetElement = document.getElementById('menuPortalTarget');
      setMenuPortalTarget(targetElement);
    }
  }, []); 
  ...
  const handleAccordionItemClick = (uuid) => {
    
    setExpandedPanel(expandedPanel === uuid ? null : uuid);
  };
              ...
              {isFilterVisible && (
                <div className="flex w-[24%] flex-col gap-[21px] md:w-full">
                  ...
                  <div className="flex flex-col gap-[21px]">
                    ...
                    <Accordion
 preExpanded={expandedPanel !== null ? [expandedPanel] : []}
 className="flex flex-col gap-[25px]"
                    >
                      {[...Array(1)].map((_, i) => (
                        <AccordionItem key={`accordionItem-${i}`}>
                          <div className="flex flex-1 flex-col gap-2">
                            <AccordionItemHeading className="w-full">
                              <AccordionItemButton onClick={() => handleAccordionItemClick(i)}>
                                <AccordionItemState>
                                  {(props) => (
                                    <>
                                        ...
                                        {props?.expanded ? (
                                          <Img
                                            ...
                                            className={`h-[16px] w-[16px] self-end ${
                                              expandedPanel === i ? "transform rotate-180" : ""
                                            }`}
                                          />
                                        ) : (
                                          <Img
  ...
  {[...Array(1)].map((_, i) => (
    <AccordionItem key={i}> {/* Added key prop */}
      <div className="flex flex-1 flex-col gap-2">
        <AccordionItemHeading className="w-full">
          <AccordionItemButton>
            <AccordionItemState>
        ...
        <AccordionItemPanel>
          <div className="relative mt-[-22px] flex w-[35%] flex-col items-start gap-[23px] md:w-full">
            ...
            <Text size="md" as="p" className="!text-blue_gray-200 underline">
              Unselect all
            </Text>
            <CheckBox
              name="casual"
